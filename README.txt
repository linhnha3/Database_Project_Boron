...
Files:
    ...
    4. frontend.py 
        - GUI for running all library functions
    5. connect_db.py
...
How to Run (in Terminal):
    ...
    3. (Optional) The normalized data is already included in the library_data folder. Running normalize.py will write over the files with the same data.
        - Command: python normalize.py

    4. IMPORTANT: In connect_db.py and create_library.py, edit 'password' to your actual MySQL root password.

    5. Create and load the database first.
    ...
    6. Run frontend.py to access all library system options.
